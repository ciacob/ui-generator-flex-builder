...
public class UiFlexBuilder implements IUiBuilder {
    ...
    private function _buildCustomComponent(container:DisplayObjectContainer, blueprint:Object):DisplayObject {
        ...
        if (classDefinition) {
            ...
            var mustHideLabel:Boolean = (hideLabelSetting === TRUE || hideLabelSetting);
            if (!mustHideLabel) {
                _buildSpacer(_container);
                _buildLabel(_container, blueprint);
            }
     ...
     * being submitted.
     */
    private static function _discardComboBoxInput(ignore:String):Object {
        return null;
    }
     ...
     */
    private static function _filterProperties(raw:Object, exclusionList:Array):Object {
        var filtered:Object = {};
        var key:String;
        var value:Object;
        for (key in raw) {
